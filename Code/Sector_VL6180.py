...
class VL6180X:
	...
	def __init__(self, address=0x29, debug=False):
		...
		if self.debug:
			...
			print ("0x0207 - {}" .format(self.get_register(0x0207)))
			print ("0x0208 - {}" .format(self.get_register(0x0208)))
			print ("0x0096 - {}" .format(self.get_register(0x0096)))
			print ("0x0097 - {}" .format(self.get_register(0x0097)))
			print ("0x00e3 - {}" .format(self.get_register(0x00e3) ) )
			print ("0x00e4 - {}" .format(self.get_register(0x00e4) ) )
			print ("0x00e5 - {}" .format(self.get_register(0x00e5) ) )
			print ("0x00e6 - {}" .format(self.get_register(0x00e6) ) )
			print ("0x00e7 - {}" .format(self.get_register(0x00e7) ) )
			print ("0x00f5 - {}" .format(self.get_register(0x00f5) ) )
			print ("0x00d9 - {}" .format(self.get_register(0x00d9) ) )
			print ("0x00db - {}" .format(self.get_register(0x00db) ) )
			print ("0x00dc - {}" .format(self.get_register(0x00dc) ) )
			print ("0x00dd - {}" .format(self.get_register(0x00dd) ) )
			print ("0x009f - {}" .format(self.get_register(0x009f) ) )
			print ("0x00a3 - {}" .format(self.get_register(0x00a3) ) )
			print ("0x00b7 - {}" .format(self.get_register(0x00b7) ) )
			print ("0x00bb - {}" .format(self.get_register(0x00bb) ) )
			print ("0x00b2 - {}" .format(self.get_register(0x00b2) ) )
			print ("0x00ca - {}" .format(self.get_register(0x00ca) ) )
			print ("0x0198 - {}" .format(self.get_register(0x0198) ) )
			print ("0x01b0 - {}" .format(self.get_register(0x01b0) ) )
			print ("0x01ad - {}" .format(self.get_register(0x01ad) ) )
			print ("0x00ff - {}" .format(self.get_register(0x00ff) ) )
			print ("0x0100 - {}" .format(self.get_register(0x0100) ) )
			print ("0x0199 - {}" .format(self.get_register(0x0199) ) )
			print ("0x01a6 - {}" .format(self.get_register(0x01a6) ) )
			print ("0x01ac - {}" .format(self.get_register(0x01ac) ) )
			print ("0x01a7 - {}" .format(self.get_register(0x01a7) ) )
			print ("0x0030 - {}" .format(self.get_register(0x0030) ) )
	...
	def default_settings(self):
		...
		if self.debug:
			...
			print ("SYSTEM_MODE_GPIO1 - {}" .format(self.get_register(self.__VL6180X_SYSTEM_MODE_GPIO1) ) )
			print ("READOUT_AVERAGING_SAMPLE_PERIOD - {}" .format( ( self.get_register(self.__VL6180X_READOUT_AVERAGING_SAMPLE_PERIOD) ) ) )
			print ("SYSALS_ANALOGUE_GAIN - {}" .format(self.get_register(self.__VL6180X_SYSALS_ANALOGUE_GAIN) ) )
			print ("SYSRANGE_VHV_REPEAT_RATE - {}".format(self.get_register(self.__VL6180X_SYSRANGE_VHV_REPEAT_RATE) ) )
			print ("SYSALS_INTEGRATION_PERIOD - {}".format(self.get_register(self.__VL6180X_SYSALS_INTEGRATION_PERIOD) ) )
			print ("SYSRANGE_VHV_RECALIBRATE - {}".format(self.get_register(self.__VL6180X_SYSRANGE_VHV_RECALIBRATE) ) )
			print ("SYSRANGE_INTERMEASUREMENT_PERIOD - {}".format(self.get_register( self.__VL6180X_SYSRANGE_INTERMEASUREMENT_PERIOD) ) )
			print ("SYSALS_INTERMEASUREMENT_PERIOD - {}" .format(self.get_register( self.__VL6180X_SYSALS_INTERMEASUREMENT_PERIOD) ) )
			print ("SYSTEM_INTERRUPT_CONFIG_GPIO - {}" .format(self.get_register( self.__VL6180X_SYSTEM_INTERRUPT_CONFIG_GPIO) ) )
			print ("SYSRANGE_MAX_CONVERGENCE_TIME - {}".format(self.get_register( self.__VL6180X_SYSRANGE_MAX_CONVERGENCE_TIME) ) )
			print ("SYSRANGE_RANGE_CHECK_ENABLES - {}".format(self.get_register(self.__VL6180X_SYSRANGE_RANGE_CHECK_ENABLES) ) )
			print ("SYSRANGE_EARLY_CONVERGENCE_ESTIMATE - {}" .format(self.get_register_16bit(self.__VL6180X_SYSRANGE_EARLY_CONVERGENCE_ESTIMATE) ) )
			print ("SYSALS_INTEGRATION_PERIOD - {}".format(self.get_register_16bit(self.__VL6180X_SYSALS_INTEGRATION_PERIOD) ) )
			print ("SYSALS_ANALOGUE_GAIN - {}".format(self.get_register(self.__VL6180X_SYSALS_ANALOGUE_GAIN) ) )
			print ("FIRMWARE_RESULT_SCALER - {}".format(self.get_register(self.__VL6180X_FIRMWARE_RESULT_SCALER) ) )
	...
	def get_distance(self):
		...
		time.sleep(0.010)
		if self.debug:
			print ("Range status: {}".format(self.get_register(self.__VL6180X_RESULT_RANGE_STATUS) & 0xF1) )
	...
	def get_ambient_light(self, als_gain):
		...
		if als_gain not in self.ALS_GAIN_ACTUAL:
			print ("Invalid gain setting: {}.  Setting to 20." .format(als_gain ) )

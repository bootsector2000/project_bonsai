...
# ===========================================================================
	...
	def printStats(self):
		print ("{:5} > Strom: {:06.2f}mA | Spannung: :{:05.2f}V | Leistung: {:06.2f}mW" . format( self.name, self.getCurrent_mA(), self.getBusVoltage_V(),  self.getPower_mW() ) )
	
	def getStats(self):
		strom = self.getCurrent_mA()
		spannung = self.getBusVoltage_V()
		leistung = self.getPower_mW()

		stats = (strom, spannung, leistung)
